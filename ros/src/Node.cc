  ...
  min_observations_per_point_(2)
{
  ...
  declare_parameter("camera_fps", rclcpp::ParameterValue(60));
  declare_parameter("camera_rgb_encoding", rclcpp::ParameterValue(true));
  declare_parameter("ORBextractor/nFeatures", rclcpp::ParameterValue(1250));
...
void Node::LoadOrbParameters(sensor_msgs::msg::CameraInfo::SharedPtr camera_info)
{
  ...
  parameters.fx = 924.002028;
  parameters.fy = 923.692935;
  parameters.cx = 631.244541;
  parameters.cy = 372.036326;
  parameters.k1 = 0.09296;
  parameters.k2 = -0.163496;
  parameters.p1 = 0.000568;
  parameters.p2 = 0.000810;
  parameters.k3 = 0.000000;
